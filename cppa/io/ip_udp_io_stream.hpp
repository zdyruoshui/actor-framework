...
#ifndef IP_UDP_IO_STREAM_HPP
#define IP_UDP_IO_STREAM_HPP

#include "cppa/io/stream.hpp"

namespace cppa { namespace io {

class ip_udp_io_stream : public stream {
 ...
 private:
    ...
    ip_udp_io_stream(native_socket_type fd);
