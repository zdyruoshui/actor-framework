...
#ifndef IP_UDP_ACCEPTOR_HPP
#define IP_UDP_ACCEPTOR_HPP
...
class ip_udp_acceptor : public acceptor {
 ...
 private:
    ...
    ip_udp_acceptor(native_socket_type fd, bool nonblocking);
